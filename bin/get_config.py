...
def get_contents(file_name):
    ...
    :return:
    """
    with open("docs/" + file_name + ".yaml", "r", encoding="UTF-8") as file:
        try:
...
demo_config = {
    ...
    "swagger_default_network": "office_network",
}
demo_defaults = {
    "databases": {
    ...
    "networks": {"has_wifi": False, "is_cloud": False, "is_public": False},
    "systems": {
...
demo_resources = {
    "resources": {
        "networks": [{"name": "office_network"}, {"name": "home_network"}],
        "users": [
            {
                "name": "user1",
...
demo_swagger_json = json.dumps(
    {
        "tags": [],
        "paths": {
            "/api/user/add": {
                "post": {
                    "description": "Receive requests from client to write users to database.",
                    ...
                    "responses": {
                        "200": {
                            "description": "OK, list of users under details",
                            "content": {
                                "application/json": {
            ...
            "/api/user": {
                "get": {
                    "description": "Endpoint to list all users from Database",
        ...
        "info": {"title": "Threat Modelling Demo", "version": "1.0.0"},
        "openapi": "3.0.2",
        "components": {
            "schemas": {
                "Response": {
...
default_security_checks = {
    ...
    "security_misconfig": {
        ...
        "remediation": "Review non-compliant controls and remediate",
        "severity": 1,
        "resource_scope": ["systems", "containers", "databases"],
        "check_query": [
    ...
    "repudiation_user": {
        ...
        "severity": 1,
        "resource_scope": ["users"],
        "check_query": [' not resources[resource]["uses_own_login"] '],
    },
    "repudiation_system": {
        "name": "STRIDE - Repudiation",
        "description": (
